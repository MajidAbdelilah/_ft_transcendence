        ...
        <div
          ...
          >
            ...
            <div className="flex flex-col justify-content overflow-auto overflow-y-scroll custom-scrollbar h-[95%]">
              ...
              <div className={`flex flex-col w-full px-2 py-1 overflow-y-auto overflow-hidden custom-scrollbar pr-[5%] h-[80%] transition-all duration-300 ${
                DashData.isScrolled
                  ...
                  <table className="w-full">
                    <thead>
                      {!DashData.isMobile ? <tr className="text-center font-semibold text-xs sm:text-sm md:text-base lg:text-lg text-[#4E5981]">
                        <th className="font-extrabold py-2 sm:py-3 md:py-4">Avatar</th>
                        <th className="font-extrabold py-2 sm:py-3 md:py-4">Name</th>
                        <th className="font-extrabold py-2 sm:py-3 md:py-4">Score</th>
                        <th className="font-extrabold py-2 sm:py-3 md:py-4">Win/Loss</th>
                    ...
                    <tbody className="py-4 sm:py-6 md:py-8">
                      {DashData.matchHistory.map((match, index) => (
                        <tr key={index} className="text-center font-semibold text-xs sm:text-sm md:text-base lg:text-lg text-[#4E5981]">
