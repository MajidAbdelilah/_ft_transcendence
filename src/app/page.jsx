  ...
  return (
    <body>
      <div className={` h-[100vh]${montserrat.className}`}>
        <nav className="flex justify-between pl-20 pt-18 pr-20 items-center h-[200px]">
        ...
        <div className="flex justify-between w-full items-center max-w-[2000px] pr-20  h-[calc(100vh_-_200px)]  mt-[-80px]">
          <div>
            <h1 className={`font-bold text-[100px] flex flex-col  pb-5 ${montserrat.className}`}>
