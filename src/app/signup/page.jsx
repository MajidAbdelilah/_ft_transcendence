...
function signup_page() {
  return (
    <div className={`h-[100vh] flex justify-center items-center ${montserrat.className}`}>
        <form className="max-w-[700px] w-[90%] bg-[rgba(66,74,120,0.05)] bg-blend-hard-light shadow-[inset_0px_0px_4.6px_#A8B4FF] p-8 rounded-xl h-[800px] w-[600px] flex flex-col items-center">
        <div className="w-full flex justify-center">
            <Image src="images/logo.svg" alt="Logo" width="100" height="100"/>    
        </div>
        <h1 className="sm:text-4xl text-xl text-center text-[#111B47] font-bold">Create your account</h1>
            <div className="mb-5 mt-8 max-w-[350px] w-full flex flex-col justify-center items-center">
                <div className='max-w-[350px] w-full'>
                    <label for="username" className="block mb-2 text-lg font-bold text-gray-900 text-[#111B47]">Username</label>
                    <input type="email" id="email" className="bg-[#F8FBFF] border  text-gray-900 text-sm rounded-[10px] focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 mb-5 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Username" required />
                    <label for="email" className="block mb-2 text-lg font-bold text-gray-900 text-[#111B47]">Email</label>
                    ...
                    <label for="password" className="block mb-2 mt-5 text-lg font-bold text-gray-900 text-[#111B47]">Password</label>
                    <input type="password" id="password" className="bg-[#F8FBFF] border  text-gray-900 text-sm rounded-[10px] focus:ring-blue-500 mb-5 focus:border-blue-500 block w-full p-3.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter your password" required />
                    <label for="Confim Password" className="block mb-2 mt-5 text-lg font-bold text-gray-900 text-[#111B47]">Confim Password</label>
