      ...
      <div className="flex flex-1 overflow-y-auto flex-wrap">
        ...
        <div className={`flex-1 overflow-y-auto flex flex-wrap items-center justify-center relative h-full ${isMobile ? '' : 'p-4'}`}>
          ...
          {is2FA && (
              ...
              <div className="bg-[#F4F4FF] flex flex-col items-center shadow-lg rounded-xl w-[95%] h-[80%] sm:h-[90%] border-solid border-[#BCBCC9] border-2 max-w-[900px] max-h-[900px] min-h-[700px] rounded-xl pt-8 animate-scaleIn">
               <div className="relative flex flex-col items-center w-full h-full">
                 ...
                 <h1 className="text-lg sm:text-xl font-bold tracking-wide text-[#242F5C] pt-4 sm:pt-8 text-right absolute top-[40%] sm:top-[25%] left-[6%] sm:left-[17%]">2FA Security code</h1>
