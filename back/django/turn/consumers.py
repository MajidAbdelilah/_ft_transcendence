...
class PingPongConsumer(AsyncWebsocketConsumer):
    ...
    async def connect(self):
        ...
        if self.room_name not in self.room_var:
            self.room_var[self.room_name] = {
                ...
                'game_start': True,
                'matches': {
                    'match1': {'player1': 'player1', 'player2': 'player2', 'winner': None},
                    'match2': {'player1': 'player3', 'player2': 'player4', 'winner': None},
                    'final': {'player1': None, 'player2': None, 'winner': None}
                }
            }            
    ...
    async def end_match(self, winner):
        ...
        player1_score = self.room_var[self.room_name]['players']['player1']['score']
        player2_score = self.room_var[self.room_name]['players']['player2']['score']
        player1_username = self.room_var[self.room_name]['players']['player1']['username']
        player2_username = self.room_var[self.room_name]['players']['player2']['username']
